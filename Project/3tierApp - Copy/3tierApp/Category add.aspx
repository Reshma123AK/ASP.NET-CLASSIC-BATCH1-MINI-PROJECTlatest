...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
        ...
        <br />
&nbsp;
&nbsp; <div class="auto-style23"><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="498px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            <Columns>
